...
function createStyles(c: Colors) {
  return StyleSheet.create({
    ...
    topBar: { backgroundColor: c.surface, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 10, gap: 10, borderBottomWidth: 1, borderBottomColor: c.borderLight },
    ...
    pointsBadge: {
      ...
      backgroundColor: c.goldAlpha, borderRadius: 8, paddingHorizontal: 7, paddingVertical: 3,
    },
